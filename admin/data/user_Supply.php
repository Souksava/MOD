<?php
  ...
  function checkInputs() {
      ...
      if (Supply_NameValue !== '' && SurnameValue !== '' && GenderValue !== '' && TelValue !== ''  && EmailValue !== ''  && PassValue !== '' && User_IDValue !== '' && P_M_IDValue !== '' ) {
  ...
  function checkInputsUpdate() {
      ...
      if (User_ID_updateValue === '') {
          setErrorFor(User_ID_update, 'ກະລຸນາປ້ອນລະຫັດຜູ້ໃຊ້');
      } else {
      ...
      if (Supply_Name_updateValue !== ''  && Surname_updateValue !== ''  && Gender_updateValue !== ''  && Tel_updateValue !== ''  && Email_updateValue !== ''  && Pass_updateValue !== ''  && User_ID_updateValue !== ''  && Uni_ID_updateValue !== ''  ) {
